...
public final class SecurityUtils {
    ...
    public static UserDto getAuthorizedUserDto() {
        return convertToUserDto(Objects.requireNonNull(getAuthorizedUserDetails()));
    }

    private static UserDto convertToUserDto(UserDetailsBuilder authorizedUserDetails) {
        UserDto userDto = new UserDto();
        userDto.setUsername(authorizedUserDetails.getUsername());
        userDto.setPassword(authorizedUserDetails.getPassword());
        return userDto;
    }
